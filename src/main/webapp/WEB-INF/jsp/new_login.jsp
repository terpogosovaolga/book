...
<div class="container">
    ...
    <form method="POST" class="form-signin" action="<c:url value='/user/login'/>">
        <h2 class="form-heading">Вход</h2>

        <div class="form-group ${error != null ? 'has-error' : ''}">
            <span>${message}</span>
            <input name="username" type="text" class="form-control" id="username" path="username" placeholder="Электронная почта"
                   autofocus="true"/>
